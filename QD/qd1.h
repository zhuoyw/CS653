...
void init_prop();
void init_wavefn();
void single_step(double*, double*, double*, double*, double*, double*, double*, double*, double*, double*, int);
void pot_prop(double*, double*, double*, int);
void kin_prop(int, double*, double*, double*, double*, double*, double*, int);
void periodic_bc();
void calc_energy();
